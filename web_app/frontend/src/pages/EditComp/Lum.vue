<template>
    <div class="container">
        <Slider class="slider" :value="lum_val" :start="0" :end="100" :step="1" @change="slider"/>
...
const algo = algorithms.filter((algo: AlgorithmI, _:number) => algo.name == "Lum")
...
function slider(val:number) {
    lum_val.value = val;
    emits('change', algo[0].url(lum_val.value));
}
