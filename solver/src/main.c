...
/*Timeout for brute force (in seconds). Update it as ne#include <math.h>       // penser a enlevereded.*/
#define TIMEOUT 30
...
int main(int argc, char *argv[])
{
    ...
    if (brute_force_s)
    {
        ...
        // game g2 = game_copy(g);
        // uint nb;
        // nb = rec_pow_of_two(game_nb_cols(g2) * game_nb_rows(g2) - 1);        //test du tobinary
        // printf("%u\n", nb);
        // to_binary(nb, g2);
        // game_print(g2, utf8);
